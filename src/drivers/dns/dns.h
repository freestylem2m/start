...
#define DNS_ICMP_INTERVAL 3*60*1000
...
extern int dns_resolve_host(context_t *,char*);
extern void dns_dnsformat(context_t *,unsigned char*,char*);
extern int dns_load_dns(context_t *);
#endif
